...
## Table of Contents
- [What Is Alert Triaging?](#what-is-alert-triaging?)
- [What Is The Ideal Triaging Process?](#what-is-the-ideal-triaging-process?)
- [1. Initial Alert Review](#1.-initial-alert-review)
- [2. Alert Classification](#2.-alert-classification)
- [3. Alert Correlation](#3.-alert-correlation)
- [4. Enrichment of Alert Data](#4.-enrichment-of-alert-data)
- [5. Risk Assessment](#5.-risk-assessment)
- [6. Contextual Analysis](#6.-contextual-analysis)
- [7. Incident Response Planning](#7.-incident-response-planning)
- [8. Consultation with IT Operations](#8.-consultation-with-it-operations)
- [9. Response Execution](#9.-response-execution)
- [10. Escalation](#10.-escalation)
- [11. Continuous Monitoring](#11.-continuous-monitoring)
- [12. De-escalation](#12.-de-escalation)

***

### What Is Alert Triaging? <a name="what-is-alert-triaging?"></a>
...
### What Is The Ideal Triaging Process? <a name="what-is-the-ideal-triaging-process?"></a>

#### 1. Initial Alert Review <a name="1.-initial-alert-review"></a>
...
#### 4. Enrichment of Alert Data <a name="4.-enrichment-of-alert-data"></a>
...
#### 5. Risk Assessment <a name="5.-risk-assessment"></a>
...
#### 6. Contextual Analysis <a name="6.-contextual-analysis"></a>
...
#### 7. Incident Response Planning <a name="7.-incident-response-planning"></a>
...
#### 8. Consultation with IT Operations <a name="8.-consultation-with-it-operations"></a>
...
#### 9. Response Execution <a name="9.-response-execution"></a>
...
#### 10. Escalation <a name="10.-escalation"></a>
...
#### 11. Continuous Monitoring <a name="11.-continuous-monitoring"></a>
...
#### 12. De-escalation <a name="12.-de-escalation"></a>
